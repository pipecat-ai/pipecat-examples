...
async def run_bot(transport: BaseTransport, handle_sigint: bool):
    ...
    task = PipelineTask(
        ...
        params=PipelineParams(
            audio_in_sample_rate=16000,  # Vonage default is 16kHz
...
async def bot(runner_args: RunnerArguments):
    ...
    # Extract phone numbers from call_data (parsed by runner utils)
    # Use this information to personalize the bot's response.
