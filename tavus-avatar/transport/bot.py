...
async def main():
    async with aiohttp.ClientSession() as session:
        ...
        async def on_connected(transport, data: dict):
            room_name = data.get("callConfig", {}).get("roomName")
            conversation_url = f"https://tavus.daily.co/{room_name}" if room_name else None
            logger.info(f"🛑🛑🛑 conversation_url: {conversation_url}")
